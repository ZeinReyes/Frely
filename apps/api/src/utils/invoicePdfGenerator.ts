...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .total-row.final { border-top: 2px solid ${color}; border-bottom: none; padding-top: 10px; font-weight: 700; font-size: 16px; color: ${color}; }
...
<body>
  ...
  <div class="footer">Generated by Frely · ${data.invoiceNumber}</div>
</body>
</html>`;
}
